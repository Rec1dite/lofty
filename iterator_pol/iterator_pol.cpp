...
class Structure {
    public:
        ...
        // VectorIterator<VectorForwardPolicy>* createIterator() {
            // return new ConcreteIterator<ConcretePolicy>(static_cast<>(this)); //
            return new VectorIterator<VectorForwardPolicy>(static_cast<VectorIterator<VectorForwardPolicy>>(this));
        }
};
